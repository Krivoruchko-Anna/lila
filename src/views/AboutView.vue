<template>
  <div class="about">
    <h2 class="about__title">What is Leela?</h2>
    <div class="about__description">
      <p>
        Leela, also known as "Leela Chakra" or "The Game of Self-Knowledge," is an ancient Indian
      ...
      <p>
        The aim of Leela is to reach the top square, which represents ultimate self-realization or
    ...
    <h2 class="about__title">The rules of the game</h2>
    <div class="about__description">
      <p>
        To begin the cycle of spiritual growth, a player must first feel a true, inner desire to
      ...
      <p>Each square has a unique significance, marked by symbols or descriptions.</p>
      <p>
        <span>Ladders:</span> Some squares act as ladders (positive virtues, states of
        consciousness, etc.), allowing the player to move up to a higher square immediately.
      </p>
      <p>
        <span>Snakes:</span> Some squares have snakes (representing vices, negative karma, or
        challenges), which cause the player to move down to a lower square.
      </p>
      <p>
        <span>The objective</span> is to progress by understanding the lesson of each square you
        land on.
      </p>
      <p>
        <span>Understanding Squares:</span>

        Each square represents a symbolic aspect of life or spiritual teaching. When a player lands
      ...
      <p>
        <span>Reaching Higher Chakras:</span>

        Many Leela boards incorporate the seven chakras, with each chakra associated with particular
      ...
      <p>
        ...
        The player who reaches the final square, representing "Moksha" or liberation, wins the game.
      ...
      <p>
        ...
        The game encourages players to reflect on their life journey, virtues, and challenges. When
